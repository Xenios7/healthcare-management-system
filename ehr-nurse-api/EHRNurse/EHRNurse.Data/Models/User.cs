...
public partial class User
{
    ...
    public bool? RequiredActions { get; set; }
    ...
    public virtual ICollection<AppointmentPatientDatum> AppointmentPatientDatumDoctors { get; set; } = new List<AppointmentPatientDatum>();

    public virtual ICollection<AppointmentPatientDatum> AppointmentPatientDatumUsers { get; set; } = new List<AppointmentPatientDatum>();
    ...
    public virtual ICollection<MedicationDatum> MedicationDatumAssignedDoctors { get; set; } = new List<MedicationDatum>();

    public virtual ICollection<MedicationDatum> MedicationDatumUsers { get; set; } = new List<MedicationDatum>();
    ...
    public virtual ICollection<Patient> PatientRegistrationAgents { get; set; } = new List<Patient>();
    ...
    public virtual ICollection<VaccinationDatum> VaccinationDatumDoctors { get; set; } = new List<VaccinationDatum>();

    public virtual ICollection<VaccinationDatum> VaccinationDatumUsers { get; set; } = new List<VaccinationDatum>();
