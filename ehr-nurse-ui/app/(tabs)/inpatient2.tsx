...
export default function Inpatient2Screen() {
    ...
    const paramPatient: PatientCard = useMemo(() => {
        try {
            const idStr = getStr(
    ...
    const navParams = {
        ...
        age:
            effectivePatient.age != null ? String(effectivePatient.age) : "",
                    ...
                    <View style={styles.patientInfo}>
                        ...
                        <View style={{ flex: 1 }}>
                            <Text style={styles.name}>
                                {effectivePatient.name} ({effectivePatient.age ?? "?"}
                                yo)
                            </Text>
                    ...
                    <View style={styles.chartCard}>
                        <View style={styles.chartHeader}>
                            <View style={{ flexDirection: "row", alignItems: "center" }}>
                                ...
                                />
                                <Text style={styles.chartHeaderText}>Vital signs overview</Text>
                            </View>
