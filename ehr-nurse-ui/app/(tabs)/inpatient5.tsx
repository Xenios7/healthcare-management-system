  ...
  return (
    ...
    >
      <View style={styles.inner}>
        {/* HEADER + PATIENT INFO έξω από το ScrollView για καλύτερο responsive */}
        ...
        {/* ΜΟΝΟ το appointment schedule είναι scrollable */}
        <ScrollView
          ...
          {appointments.map((appt, i) => (
            <View key={i} style={styles.appointmentCard}>
              ...
              <View style={styles.row}>
                ...
                <MaterialCommunityIcons
                  style={styles.checkCirclePadding}
                  name="check-circle"
                  size={18}
                  color="#41B06E"
                />
              ...
              <View style={styles.buttonRow}>
                <TouchableOpacity
                  style={[styles.btnNotAttend, styles.btnSpacing]}
                >
                  <Text style={styles.btnText}>Did not attend</Text>
                </TouchableOpacity>

                <TouchableOpacity
                  style={[styles.btnPostponed, styles.btnSpacing]}
                >
                  <Text style={styles.btnText}>Postponed</Text>
                </TouchableOpacity>

                <TouchableOpacity
                  style={[styles.btnCompleted, styles.btnSpacing]}
                >
